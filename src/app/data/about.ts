import { Handshake, Heart, ShieldCheck, TrendingUp } from "lucide-react";
...
export const TEAM_MEMBERS = [
  { name: "Stephen Onyekwere", role: "Principal Consultant" },
  { name: "Team Member", role: "Clinical Specialist" },
  { name: "Team Member", role: "Senior Supervisor" },
];
...
export const FAQS = [
  "Who is Ethos Clinical Supervision for?",
  "What is clinical supervision?",
  "How is Ethos different from other supervision models?",
  "How does reflective supervision support practitioners?",
  "Can Ethos work with organisations as well as individuals?",
];

export const ETHOS_COMMITMENTS = [
  {
    icon: ShieldCheck,
    title: "Ethical grounding",
    desc: "Every supervision session is anchored in clinical evidence, philosophical inquiry, and genuine care for the people doing the work.",
  },
  {
    icon: Handshake,
    title: "True organisational partnership",
    desc: "We collaborate with agencies as trusted partners, not external vendors.",
  },
  {
    icon: Heart,
    title: "Integrity over growth",
    desc: "We deliberately limit our caseload to ensure the depth and quality of every supervision relationship.",
  },
  {
    icon: TrendingUp,
